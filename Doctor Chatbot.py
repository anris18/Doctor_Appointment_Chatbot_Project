...
csv_file = "zocdoc.csv"  # Replace with the actual path to your CSV file
if not os.path.exists(csv_file):
    st.error(f"Dataset file '{csv_file}' not found! Please ensure the file exists in the correct location.")
    st.stop()
